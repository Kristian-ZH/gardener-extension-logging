...
func getPromtailConfigurationFile(ctx context.Context, lokiIngress, apiServerURL string) (extensionsv1alpha1.File, error) {
...
func getPromtailCAFile(ctx context.Context, caBundle []byte) extensionsv1alpha1.File {
	return extensionsv1alpha1.File{
		Path:        PathCACert,
		Permissions: pointer.Int32(0644),
		Content: extensionsv1alpha1.FileContent{
