...
func New(
	...
	return &eventLogger{
		client:                 client,
		namespace:              namespace,
		genericTokenKubeconfig: geneticTokenKbcfg,
		values:                 values,
	}, nil
}
...
func (l *eventLogger) reconcileDeployment(ctx context.Context) error {
	...
	_, err := controllerutils.GetAndCreateOrMergePatch(ctx, l.client, deployment, func() error {
		...
		utilruntime.Must(gutil.InjectGenericKubeconfig(deployment, l.genericTokenKubeconfig, gutil.SecretNamePrefixShootAccess+name))
